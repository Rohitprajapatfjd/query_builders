...
<body> 
    <div class=" bg-gray-800 bg-opacity-90 w-full h-screen ">
        ...
        <h1 class="text-center py-7 text-3xl text-white/70 font-bold">Update User Form</h1>

        <form action={{route('postUpdate')}}  method="POST" class=" max-w-sm sm:max-w-md pt-3 mx-auto">
              @csrf
            <div class="relative z-0 w-2/3 mx-auto sm:mx-0 sm:w-full mb-5 group">
                ...
                <input type="text" name="fullname" id="fullname"
                    ...
                    placeholder=" " value={{$datas ? $datas->fullname : ""}} required />
                <label for="fullname"
            ...
            <div class="relative z-0  w-2/3 mx-auto sm:mx-0 sm:w-full mb-5 group">
                <input type="email" name="email" value={{$datas ? $datas->email : ""}} id="floating_email"
                    class="block py-2.5 px-0 w-full text-sm  bg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer"
            ...
            <div class="relative z-0  w-2/3 mx-auto sm:mx-0 sm:w-full mb-5 group">
                <input type="text" name="mobile_no" value={{$datas ? $datas->phoneno : ""}} id="mobile_no"
                    class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer"
                    placeholder=" " required />
                <label for="mobile_no"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-2/3 mx-auto sm:mx-0 sm:w-full mb-5 group">
                    <input type="text" name="age" value={{$datas ? $datas->age : ""}} id="age"
                        class="block py-2.5 px-0 w-full text-sm  bg-transparent border-0 border-b-2  appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0  peer"
                        placeholder=" " required />
                    <label for="age"
                ...
                <div class="relative z-0  w-2/3 mx-auto sm:mx-0 sm:w-full mb-5 group">
                    <input type="text" name="city"value={{$datas ? $datas->city : ""}}  id="city"
